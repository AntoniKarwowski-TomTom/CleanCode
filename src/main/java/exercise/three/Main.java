...
import exercise.three.model.DynamicLocation;
import exercise.three.model.EppPoi;
...
public class Main {
     ...
     */
    public static EppPoi getMatchedPoiItem(DynamicLocation dynamicLocation, List<EppPoi> poiItemsReturnedFromDB) {
        ...
        if (numberOfMatchedPois == 0) {
            ...
            Instant latestTime =
                    Instant.parse(addMissingTimeZoneAsUTC(poiItemsReturnedFromDB.get(0).getLastProcessingTime()));
